...
WARNING. The initial version of this guide was based on Refinery CMS 2.1.0. It has been updated for Refinery 3.0.0, but these updates are subject to further review and editing.
...
* The "Ruby":http://www.ruby-lang.org/en/downloads language version at least 2
...
<shell>
$ rails new rickrockstar -m http://refinerycms.com/t/3.0.0
</shell>

TIP.  If you wish to to use the edge version, try
...
TIP.  These instructions do not work at present (22 Dec 2015) because this method downloads an incompatible version of refinerycms-acts-as-indexed.  
